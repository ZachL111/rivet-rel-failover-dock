"""Regression checks for the rivet-rel-failover-dock casebook."""
...
from casebook.harness import assert_expected, rivet_rel_failover_dock_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(rivet_rel_failover_dock_summary(), assert_expected())
